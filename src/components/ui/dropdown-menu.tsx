...
const dropdownRowHighlight = "focus:bg-foreground/15 focus:text-accent-foreground dark:focus:bg-foreground/20"
const dropdownRowOpen = "data-popup-open:bg-foreground/15 data-open:bg-foreground/15 dark:data-popup-open:bg-foreground/20 dark:data-open:bg-foreground/20"
